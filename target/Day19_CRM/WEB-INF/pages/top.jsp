							...
							<table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
								<tr>
									...
									<td width="51" valign="middle">
										...
										--%>
										<a href="${pageContext.request.contextPath}/staff/updPwd" target="right">
									...
									<td width="55" valign="middle"><a href="${pageContext.request.contextPath}/staff/logout" target="_top"><font color="ffffff">重新登录</font></a></td>
								</tr>
							</table>
						</div>
						</td>
