	 ...
	 <tr>
	    ...
	    <td><select name="crmDepartment.depid">
            ...
            <c:forEach items="${departments}" var="dept">
                <option value="${dept.depid}" ${crmPost.depid==dept.depid?"selected='selected'":""}>${dept.depname}</option>
            </c:forEach>
	    ...
	    <td>职务：</td>
	    <td><input type="text" name="postname" value="${crmPost.postname}"/>
            <input type="hidden" name="postid" value="${crmPost.postid}"/>
        </td>
	  </tr>
